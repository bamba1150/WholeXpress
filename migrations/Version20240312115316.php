 ...
 */
final class Version20240312115316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, commercial_id INT DEFAULT NULL, reclamations_id INT DEFAULT NULL, email_client VARCHAR(25) NOT NULL, adresse_client VARCHAR(25) NOT NULL, nom_complet_client VARCHAR(25) NOT NULL, type VARCHAR(255) NOT NULL, INDEX IDX_C74404557854071C (commercial_id), INDEX IDX_C74404551853BCF7 (reclamations_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
