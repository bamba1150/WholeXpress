 ...
 */
final class Version20240208132809 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD client_id INT NOT NULL, ADD produits_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP client_id, DROP produits_id');
    }
}
